...
public class AdsExtentManger {
    public static void log(Status status, String message) {
        if (AdsReporting.getTest() != null) {
            AdsReporting.getTest().log(status, message);
        }
    }
    //log colored
    public static void logColored(Status status, String message, ExtentColor color) {
        if (AdsReporting.getTest() != null) {
            AdsReporting.getTest().log(status, MarkupHelper.createLabel(message, color));
        }
    }
