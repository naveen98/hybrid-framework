...
public class AdsReporting extends TestListenerAdapter {
	...
	public void onTestFailure(ITestResult result) {
		...
		extentTest.get().log(Status.FAIL,
				MarkupHelper.createLabel("Exception: " + result.getThrowable(), ExtentColor.RED));
		...
		try {
			...
			if (testInstance instanceof AdsBaseClass) {
				...
				if (driver != null) {
					String screenshotPath = ((AdsBaseClass) testInstance).captureScreenshot(driver,
	...
	public void onFinish(ITestContext context) {
		ExtentTest summaryTest = extent.createTest("Final Test Summary");

		TestcaseLogger.logSummary(summaryTest);
		summaryTest.log(Status.INFO, MarkupHelper.createLabel("Test Class: " + context.getName(), ExtentColor.GREY));
	    summaryTest.log(Status.INFO, MarkupHelper.createLabel("Total Test Cases: " + Testcasecount.getTotal(), ExtentColor.BLUE));
	    summaryTest.log(Status.INFO, MarkupHelper.createLabel("Passed: " + Testcasecount.getPassed(), ExtentColor.GREEN));
	    summaryTest.log(Status.INFO, MarkupHelper.createLabel("Failed: " + Testcasecount.getFailed(), ExtentColor.RED));
	    summaryTest.log(Status.INFO, MarkupHelper.createLabel("Skipped: " + Testcasecount.getSkipped(), ExtentColor.ORANGE));
